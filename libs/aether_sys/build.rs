...
fn main() {
    ...
    println!("cargo:rerun-if-changed=../../kernel/api/syscalls/syscalls.toml");
    println!("cargo:rerun-if-changed=../../kernel/api/syscalls/errors.toml");
    println!("cargo:rerun-if-changed=../../kernel/api/syscalls/syscall_parser.py");
    ...
    let output = Command::new(&python)
        .arg("syscall_aether_sys_gen.py")
        .arg("../../kernel/api/syscalls/syscalls.toml")
        .arg("../../kernel/api/syscalls/errors.toml")
